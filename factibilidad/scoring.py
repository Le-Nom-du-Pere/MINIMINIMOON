...
class FactibilidadScorer:
    ...
    def score_text(self, text: str, similarity_score: float = 0.0) -> Dict:
        ...
        legacy_total_score = (
            self.base_score + individual_scores["total"] + cluster_scores["total"]
        )
    ...
    def _calculate_individual_scores(
        ...
        for pattern_type, pattern_matches in matches.items():
            if pattern_matches:
                ...
                scores[pattern_type] = {"score": 0.0, "count": 0, "matches": []}
    ...
    def _generate_analysis(
        matches: Dict[str, List[PatternMatch]], clusters: List[Dict]
    ) -> Dict:
