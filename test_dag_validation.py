...
class TestDAGValidator(unittest.TestCase):
    ...
    def test_seed_generation_different_plans(self):
        ...
        self.assertNotEqual(seed1, seed2, "Different plan names should produce different seeds")
    ...
    def test_acyclicity_check_simple_dag(self):
        ...
        self.assertTrue(self.validator._is_acyclic(nodes), "Simple DAG should be acyclic")
    ...
    def test_acyclicity_check_cycle(self):
        ...
        self.assertFalse(self.validator._is_acyclic(nodes), "Graph with cycle should not be acyclic")
    ...
    def test_single_node_acyclic(self):
        ...
        self.assertTrue(self.validator._is_acyclic(nodes), "Single node should be acyclic")
...
class TestSampleCausalGraph(unittest.TestCase):
    ...
    def test_sample_graph_reproducibility(self):
        ...
        self.assertTrue(is_reproducible, "Sample graph should produce reproducible results")
