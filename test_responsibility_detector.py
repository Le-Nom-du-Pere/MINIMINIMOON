...
class TestResponsibilityDetector:
    ...
    def test_official_position_detection(self, detector):
        ...
        position_entities = [e for e in result['entities'] if e.entity_type == EntityType.POSITION]
    ...
    def test_pattern_coverage(self, detector):
        ...
        for text, should_detect in test_cases:
            ...
            if should_detect:
                ...
                assert any(e.confidence > 0.5 for e in entities), f"Low confidence for: {text}"
