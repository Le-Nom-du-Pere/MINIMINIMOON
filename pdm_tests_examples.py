...
# tests/fixtures/sample_pdm.txt
"""
Sample PDM document for testing.
"""
PLAN DE DESARROLLO MUNICIPAL
"CONSTRUYENDO FUTURO"
MUNICIPIO DE SAN EJEMPLO
2024-2027

CAPÍTULO 1: DIAGNÓSTICO

El municipio de San Ejemplo cuenta con una población de 50,000 habitantes,
distribuidos en 20 veredas y 15 barrios urbanos. Los principales desafíos
identificados son:

1. Educación: Cobertura del 75%, deserción escolar del 12%
2. Salud: Mortalidad infantil de 15 por mil nacidos vivos
3. Agua potable: Cobertura del 80% en zona urbana, 40% en zona rural
4. Seguridad: Tasa de homicidios de 25 por 100,000 habitantes

CAPÍTULO 2: PARTE ESTRATÉGICA

VISIÓN:
En 2027, San Ejemplo será un municipio modelo en desarrollo sostenible,
con educación de calidad, salud integral y servicios públicos eficientes.

MISIÓN:
Garantizar el bienestar de todos los habitantes mediante una gestión
transparente, participativa y eficiente de los recursos públicos.

OBJETIVOS ESTRATÉGICOS:

OE1: Educación de Calidad
- Aumentar la cobertura educativa al 95%
- Reducir la deserción escolar al 5%
- Mejorar la calidad educativa

OE2: Salud para Todos
- Reducir la mortalidad infantil a 7 por mil
- Aumentar la cobertura en salud al 100%
- Fortalecer la atención primaria

OE3: Servicios Públicos Eficientes
- Garantizar agua potable al 100% de la población
- Implementar sistema de alcantarillado completo
- Mejorar la gestión de residuos sólidos

CAPÍTULO 3: PROGRAMAS Y PROYECTOS

PROGRAMA 1: EDUCACIÓN TRANSFORMADORA

META 1.1: Alcanzar 95% de cobertura educativa
INDICADOR: Tasa de cobertura neta
LÍNEA BASE: 75%
META 2027: 95%

Sin embargo, el presupuesto educativo será reducido en 30% debido a
restricciones fiscales.

ACCIONES:
- El municipio contratará directamente 100 docentes nuevos
- Construcción de 5 nuevas aulas escolares
- Dotación de material pedagógico

PROGRAMA 2: SALUD INTEGRAL

META 2.1: Reducir mortalidad infantil en 50%
INDICADOR: Tasa de mortalidad infantil
LÍNEA BASE: 15 por mil
META 2027: 7.5 por mil

ACCIONES:
- El municipio construirá y administrará un hospital de tercer nivel
- Implementar brigadas de salud mensuales
- Fortalecer programas de vacunación

Pero no se contemplan recursos específicos para prevención.

PROGRAMA 3: AGUA PARA LA VIDA

META 3.1: Cobertura 100% agua potable
INDICADOR: Porcentaje de cobertura
LÍNEA BASE: 60%
META 2027: 100%

No obstante, solo se asignan recursos para cubrir el 80% de la meta.

CAPÍTULO 4: PLAN PLURIANUAL DE INVERSIONES

PRESUPUESTO TOTAL: $40,000 millones COP (2024-2027)

DISTRIBUCIÓN POR SECTOR:
- Educación: $8,000 millones (20%) - Reducción del 30% respecto al periodo anterior
- Salud: $12,000 millones (30%)
- Agua y saneamiento: $10,000 millones (25%)
- Otros sectores: $10,000 millones (25%)

Se proyecta incrementar la inversión social en 40%, aunque los ingresos
propios solo crecerán 10% según las proyecciones del Marco Fiscal.

CAPÍTULO 5: SEGUIMIENTO Y EVALUACIÓN

Se establecerá un sistema de seguimiento trimestral con indicadores de
gestión, producto y resultado. El Consejo Territorial de Planeación
realizará seguimiento ciudadano.

Sin embargo, no se define presupuesto específico para el sistema de monitoreo.