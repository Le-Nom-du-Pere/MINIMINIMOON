...
class TestContradictionDetector(unittest.TestCase):
    ...
    def test_pattern_matching_actions(self):
        ...
        self.assertTrue(len(matches) >= 3)  # implementar, desarrollar, ejecutar
    ...
    def test_extract_context_window(self):
        ...
        text = "Este es un texto largo para probar la extracción de ventana de contexto."
    ...
    def test_detect_contradictions_high_risk(self):
        ...
        self.assertTrue(analysis.summary["medium-high"] > 0 or analysis.summary["high"] > 0)
        ...
        for i, example in enumerate(examples):
            with self.subTest(example_index=i):
                ...
                if analysis.highest_confidence_contradiction:
                    self.assertTrue(analysis.highest_confidence_contradiction.confidence > 0.4,
    ...
    def test_edge_cases(self):
        ...
        analysis = self.detector.detect_contradictions("La meta es implementar programas.")
        self.assertEqual(analysis.total_contradictions, 0)
