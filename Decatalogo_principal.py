...
def cargar_decalogo_industrial() -> List[Any]:
    ...
    try:
        ...
        LOGGER.info(
            "⚠️  Plantilla textual de respaldo del decálogo activada (%d caracteres)",
            len(fallback_raw),
        )
  ...
  python Decatalogo_principal.py ./planes/ --max-segmentos 500 --batch-size 64
    ...
    if input_path.is_dir():
        ...
        def procesar_con_args(pdf_path):
            return procesar_plan_industrial(
                pdf_path, args.max_segmentos, args.batch_size
            )
        ...
        nombre_plan, metrics = procesar_plan_industrial(
            input_path, args.max_segmentos, args.batch_size
        )
