...
try:
    ...
    pdfplumber = None
    LOGGER.warning(
        "⚠️  pdfplumber no disponible. Algunas funciones de extracción de PDF pueden no estar disponibles."
    )
import spacy
...
class OntologiaPoliticas:
    ...
    def cargar_estandar(cls) -> "OntologiaPoliticas":
        ...
        try:
            ...
            log_error_with_text(
                LOGGER, f"❌ Error crítico cargando ontología industrial: {e}"
            )
            raise SystemExit(
                "Fallo en carga de ontología - Requiere intervención manual"
            )
...
def cargar_decalogo_industrial() -> List[Any]:
        ...
        try:
            ...
            for i, item in enumerate(data):
                try:
                    ...
                    if item["id"] != i + 1:
                        raise ValueError(
                            f"ID de dimensión incorrecto: esperado {i + 1}, encontrado {item['id']}"
                        )
                    ...
                    if not teoria_cambio.verificar_identificabilidad():
                        raise ValueError(
                            f"Teoría de cambio no identificable en dimensión {i + 1}"
                        )
                    ...
                    for j, eslabon_data in enumerate(item["eslabones"]):
                        try:
                            eslabon = EslabonCadena(
                                ...
                                capacidades_requeridas=eslabon_data[
                                    "capacidades_requeridas"
                                ],
                                puntos_criticos=eslabon_data["puntos_criticos"],
                                ventana_temporal=tuple(
                                    eslabon_data["ventana_temporal"]
                                ),
                                kpi_ponderacion=float(
                                    eslabon_data.get("kpi_ponderacion", 1.0)
                                ),
                            )
                            eslabones.append(eslabon)
                        except Exception as e:
                            raise ValueError(
                                f"Error en eslabón {j + 1} de dimensión {i + 1}: {e}"
                            )
                    ...
                    raise SystemExit(
                        f"Fallo en validación de dimensión {i + 1} - Requiere corrección manual"
                    )

            LOGGER.info(
                f"✅ Decálogo industrial cargado y validado: {len(decalogos)} dimensiones"
            )
            return decalogos
            ...
            raise SystemExit(
                "Fallo en carga de decálogo - Requiere intervención manual"
            )
    ...
    template_industrial = [
        {
            ...
            "teoria_cambio": {
                "supuestos_causales": [
                    "Reducción violencia → Mejoramiento seguridad humana",
                ...
                "resultados_intermedios": [
                    "disminución homicidios",
                    "aumento percepción seguridad",
            ...
            "eslabones": [
                {
                    ...
                    "capacidades_requeridas": [
                        "analistas_seguridad",
                        "gestores_conflicto",
                        "monitores_territoriales",
                    ],
                    "puntos_criticos": [
                        "disponibilidad_financiera",
                ...
                },
                {
                    ...
                    "tipo": "PROCESOS",
                    "indicadores": [
                        "planes_implementados",
                        "mesas_coordinación",
                        "protocolos_activados",
                    ],
                    "capacidades_requeridas": [
                        "coordinadores_interinstitucionales",
                        "facilitadores_comunitarios",
                        "analistas_datos",
                    ],
                    "puntos_criticos": [
                        "coordinación_interinstitucional",
                ...
                },
                {
                    ...
                    "puntos_criticos": [
                        "sostenibilidad_técnica",
                        "cobertura_poblacional",
                        "calidad_servicio",
                    ],
                ...
                },
                {
                    ...
                    "capacidades_requeridas": [
                        "evaluadores_impacto",
                        "investigadores_campo",
                        "analistas_políticas",
                    ],
                    "puntos_criticos": [
                        "calidad_datos",
                        "atribución_causal",
                        "representatividad_muestral",
                    ],
                ...
                },
                {
                    ...
                    "tipo": "IMPACTOS",
                    "indicadores": [
                        "índice_paz_territorial",
                        "desarrollo_humano",
                        "cohesión_social",
                    ],
                    "capacidades_requeridas": [
                        "investigadores_largo_plazo",
                        "economistas_desarrollo",
                        "sociólogos",
                    ],
                    "puntos_criticos": [
                        "atribución_causal",
        ...
        },
        {
            ...
            "teoria_cambio": {
                "supuestos_causales": [
                    "Políticas con enfoque de género → Reducción brechas estructurales",
                    "Empoderamiento económico → Autonomía de mujeres",
                ],
                "mediadores": {
                    "institucionales": [
                        "presupuesto_sensible_género",
                        "mecanismos_participación",
                        "sistemas_monitoreo",
                    ],
                    "sociales": [
                        "transformación_cultural",
                        "educación_igualdad",
                        "redes_apoyo",
                    ],
                },
                "resultados_intermedios": [
                    "aumento_participación_femenina",
                    "reducción_brecha_salarial",
            ...
            "eslabones": [
                {
                    ...
                    "capacidades_requeridas": [
                        "expertos_género",
                        "gestores_presupuesto",
                        "facilitadores_comunitarios",
                    ],
                    "puntos_criticos": [
                        "sensibilización_institucional",
                ...
                },
                {
                    ...
                    "tipo": "PROCESOS",
                    "indicadores": [
                        "políticas_implementadas",
                        "mecanismos_participación",
                        "protocolos_atención",
                    ],
                    "capacidades_requeridas": [
                        "coordinadores_género",
                        "facilitadores_diálogo",
                        "analistas_datos",
                    ],
                    "puntos_criticos": [
                        "articulación_institucional",
                        "participación_significativa",
                ...
                },
                {
                    ...
                    "tipo": "RESULTADOS",
                    "indicadores": [
                        "índice_autonomía_económica",
                        "tasa_participación_laboral",
                ...
                },
                {
                    ...
                    "tipo": "IMPACTOS",
                    "indicadores": [
                        "índice_equidad_género",
                        "desarrollo_humano_mujeres",
                        "transformación_cultural",
                    ],
                    "capacidades_requeridas": [
                        "investigadores_largo_plazo",
        ...
        },
        {
            ...
            "teoria_cambio": {
                "supuestos_causales": [
                    "Inversión educativa → Mejora calidad educativa",
                    "Formación docente → Resultados aprendizaje",
                ],
                "mediadores": {
                    "institucionales": [
                        "infraestructura_escolar",
                        "material_didáctico",
                        "sistemas_evaluación",
                    ],
                    "pedagógicos": [
                        "metodologías_activas",
                        "evaluación_formativa",
                        "acompañamiento_docente",
                    ],
                },
                "resultados_intermedios": [
                    "mejora_puntajes_pruebas",
                    "reducción_deserción",
                    "aumento_cobertura",
                ],
                "precondiciones": [
                    "voluntad_política",
                    "presupuesto_adecuado",
                    "marco_curricular",
                ],
            },
            "eslabones": [
                ...
                },
                {
                    ...
                    "tipo": "PROCESOS",
                    "indicadores": [
                        "planes_mejora_implementados",
                        "programas_formación",
                        "sistemas_monitoreo",
                    ],
                    "capacidades_requeridas": [
                        "coordinadores_pedagógicos",
                        "facilitadores_formación",
                        "analistas_datos",
                    ],
                    "puntos_criticos": [
                        "articulación_niveles",
                        "pertinencia_territorial",
                ...
                },
                {
                    ...
                    "capacidades_requeridas": [
                        "diseñadores_curriculares",
                        "desarrolladores_tecnológicos",
                        "especialistas_contenido",
                    ],
                    "puntos_criticos": [
                        "calidad_contenido",
                        "accesibilidad_tecnológica",
                        "actualización_periódica",
                    ],
                    "ventana_temporal": [12, 24],
                    "kpi_ponderacion": 1.0,
                },
                {
                    ...
                    "tipo": "RESULTADOS",
                    "indicadores": [
                        "puntajes_pruebas_estandarizadas",
                        "tasa_retención",
                        "satisfacción_estudiantes",
                    ],
                    "capacidades_requeridas": [
                        "evaluadores_educativos",
                        "investigadores_aprendizaje",
                        "analistas_políticas",
                    ],
                    "puntos_criticos": [
                        "medición_confiable",
                ...
                },
                {
                    ...
                    "tipo": "IMPACTOS",
                    "indicadores": [
                        "índice_desarrollo_humano",
                        "productividad_laboral",
                        "cohesión_social",
                    ],
                    "capacidades_requeridas": [
                        "investigadores_largo_plazo",
                        "economistas_educación",
                        "sociólogos",
                    ],
                    "puntos_criticos": [
                        "impacto_estructural",
        ...
        },
        {
            ...
            "teoria_cambio": {
                "supuestos_causales": [
                    "Inversión salud → Mejora acceso servicios",
                ...
                "mediadores": {
                    ...
                    "comunitarios": [
                        "promoción_salud",
                        "prevención_comunitaria",
                        "autocuidado",
                    ],
                },
                "resultados_intermedios": [
                    "aumento_cobertura",
                    "reducción_mortalidad",
                    "mejora_percepción_calidad",
                ],
                "precondiciones": [
                    "voluntad_política",
                    "presupuesto_adecuado",
            ...
            "eslabones": [
                ...
                },
                {
                    ...
                    "tipo": "PROCESOS",
                    "indicadores": [
                        "programas_implementados",
                        "campañas_prevención",
                        "sistemas_referencia",
                    ],
                    "capacidades_requeridas": [
                        "coordinadores_programas",
                        "facilitadores_comunitarios",
                        "analistas_datos",
                    ],
                    "puntos_criticos": [
                ...
                },
                {
                    ...
                    "indicadores": [
                        "tasa_mortalidad",
                        "cobertura_servicios",
                        "satisfacción_usuarios",
                    ],
                    "capacidades_requeridas": [
                        "evaluadores_salud",
                        "investigadores_epidemiología",
                        "analistas_políticas",
                    ],
                    "puntos_criticos": [
                        "medición_precisa",
                        "atribución_causal",
                        "factores_socioeconómicos",
                    ],
                    "ventana_temporal": [24, 48],
                    "kpi_ponderacion": 1.4,
                },
        ...
        },
        {
            ...
            "teoria_cambio": {
                "supuestos_causales": [
                    ...
                    "Capacitación → Empleo decente",
                ],
                "mediadores": {
                    "institucionales": [
                        "infraestructura_productiva",
                        "apoyo_financiero",
                        "sistemas_innovación",
                    ],
                    "empresariales": [
                        "formación_empresarial",
                        "acceso_mercados",
                        "alianzas_productivas",
                    ],
                },
                "resultados_intermedios": [
                    "aumento_empleo",
                    "crecimiento_PIB",
                    "diversificación_productiva",
                ],
                "precondiciones": [
                    "estabilidad_macro",
                    "marco_legal",
            ...
            "eslabones": [
                ...
                },
                {
                    ...
                    "indicadores": [
                        "programas_implementados",
                        "alianzas_productivas",
                        "sistemas_financiamiento",
                    ],
                    "capacidades_requeridas": [
                        "coordinadores_programas",
                        "facilitadores_negocios",
                        "analistas_mercado",
                    ],
                    "puntos_criticos": [
                        "articulación_actores",
                        "pertinencia_territorial",
                ...
                },
                {
                    ...
                    "capacidades_requeridas": [
                        "emprendedores",
                        "gestores_negocios",
                        "especialistas_comercialización",
                    ],
                    "puntos_criticos": [
                        "calidad_productos",
                        "sostenibilidad_empresas",
                ...
                },
                {
                    ...
                    "indicadores": [
                        "tasa_empleo",
                        "crecimiento_PIB_local",
                        "productividad_sectorial",
                    ],
                    "capacidades_requeridas": [
                        "evaluadores_económicos",
                        "investigadores_mercado",
                        "analistas_políticas",
                    ],
                    "puntos_criticos": [
                        "medición_precisa",
        ...
        },
        {
            ...
            "teoria_cambio": {
                "supuestos_causales": [
                    "Gestión ambiental → Conservación ecosistemas",
                ...
                "mediadores": {
                    ...
                    "comunitarios": [
                        "educación_ambiental",
                        "prácticas_sostenibles",
                        "vigilancia_ciudadana",
                    ],
                },
                "resultados_intermedios": [
                    "reducción_emisiones",
                    "conservación_biodiversidad",
            ...
            "eslabones": [
                {
                    ...
                    "indicadores": [
                        ...
                        "personal_especializado",
                        "equipamiento_técnico",
                    ],
                    "capacidades_requeridas": [
                        "gestores_ambientales",
                        "técnicos_monitoreo",
                        "educadores_ambientales",
                    ],
                    "puntos_criticos": [
                        "disponibilidad_recursos",
                ...
                },
                {
                    ...
                    "capacidades_requeridas": [
                        "biólogos",
                        "ingenieros_ambientales",
                        "educadores",
                    ],
                    "puntos_criticos": [
                        "calidad_técnica",
                        "sostenibilidad_ecológica",
                        "aceptación_social",
                    ],
                ...
                },
                {
                    ...
                    "tipo": "RESULTADOS",
                    "indicadores": [
                        "índice_calidad_ambiental",
                        "reducción_emisiones",
                        "percepción_riesgo",
                    ],
                    "capacidades_requeridas": [
                        "evaluadores_ambientales",
                        "investigadores_cambio_climático",
                        "analistas_políticas",
                    ],
                    "puntos_criticos": [
                        "medición_científica",
                ...
                },
                {
                    ...
                    "tipo": "IMPACTOS",
                    "indicadores": [
                        "índice_sostenibilidad",
                        "resiliencia_territorial",
                        "calidad_vida_ambiental",
                    ],
                    "capacidades_requeridas": [
                        "investigadores_largo_plazo",
                        "científicos_clima",
        ...
        },
        {
            ...
            "teoria_cambio": {
                "supuestos_causales": [
                    "Inversión infraestructura → Mejora conectividad",
                ...
                "resultados_intermedios": [
                    "reducción_tiempo_desplazamiento",
                    "aumento_cobertura_servicios",
                    "mejora_accesibilidad",
                ],
                "precondiciones": [
                    "planificación_urbana",
            ...
            "eslabones": [
                ...
                },
                {
                    ...
                    "puntos_criticos": [
                        "calidad_construcción",
                        "sostenibilidad_operativa",
                ...
                },
                {
                    ...
                    "indicadores": [
                        "índice_movilidad",
                        "tiempo_promedio_desplazamiento",
                        "satisfacción_usuarios",
                    ],
                    "capacidades_requeridas": [
                        "evaluadores_infraestructura",
                        "investigadores_urbanismo",
                        "analistas_políticas",
                    ],
                    "puntos_criticos": [
                        "medición_objetiva",
                        "atribución_causal",
                        "factores_demográficos",
                    ],
                    "ventana_temporal": [48, 84],
                    "kpi_ponderacion": 1.5,
                },
                {
                    ...
                    "tipo": "IMPACTOS",
                    "indicadores": [
                        "índice_desarrollo_urbano",
                        "productividad_económica",
                        "calidad_vida_ciudadana",
                    ],
                    "capacidades_requeridas": [
                        "investigadores_largo_plazo",
                        "urbanistas",
        ...
        },
        {
            ...
            "teoria_cambio": {
                "supuestos_causales": [
                    "Participación ciudadana → Mejora decisiones públicas",
                    "Transparencia → Confianza institucional",
                ],
                "mediadores": {
                    "institucionales": [
                        "mecanismos_participación",
                        "sistemas_transparencia",
                        "capacidades_gobierno",
                    ],
                    "ciudadanos": [
                        "organización_social",
                        "veedurías",
                ...
                "resultados_intermedios": [
                    "aumento_participación",
                    "mejora_percepción_transparencia",
            ...
            "eslabones": [
                {
                    ...
                    "tipo": "INSUMOS",
                    "indicadores": [
                        "presupuesto_gobernanza",
                        "personal_especializado",
                        "plataformas_digitales",
                    ],
                    "capacidades_requeridas": [
                        "gestores_participación",
                        "expertos_transparencia",
                        "facilitadores_diálogo",
                    ],
                    "puntos_criticos": [
                        "disponibilidad_recursos",
                ...
                },
                {
                    ...
                    "tipo": "PRODUCTOS",
                    "indicadores": [
                        "espacios_participación",
                        "informes_transparencia",
                        "sistemas_quejas",
                    ],
                    "capacidades_requeridas": [
                        "facilitadores_diálogo",
                        "gestores_información",
                        "mediadores",
                    ],
                    "puntos_criticos": [
                        "calidad_procesos",
                ...
                },
                {
                    ...
                    "tipo": "RESULTADOS",
                    "indicadores": [
                        "índice_participación",
                        "percepción_transparencia",
                        "confianza_institucional",
                    ],
                    "capacidades_requeridas": [
                        "evaluadores_gobernanza",
                        "investigadores_políticos",
                        "analistas_políticas",
                    ],
                    "puntos_criticos": [
                        "medición_confiable",
        ...
        },
        {
            ...
            "teoria_cambio": {
                "supuestos_causales": [
                    "Inversión I+D → Innovación tecnológica",
                ...
                "mediadores": {
                    "tecnológicos": [
                        ...
                        "talento_tecnológico",
                        "ecosistemas_innovación",
                    ],
                    "organizacionales": [
                        "cultura_innovación",
                        "procesos_ágiles",
                        "gestión_conocimiento",
                    ],
                },
                "resultados_intermedios": [
                    "aumento_patentes",
            ...
            "eslabones": [
                {
                    ...
                    "indicadores": [
                        "presupuesto_I+D",
                        "infraestructura_tecnológica",
                        "talento_especializado",
                    ],
                    "capacidades_requeridas": [
                        "gestores_innovación",
                        "científicos",
                ...
                },
                {
                    ...
                    "indicadores": [
                        "proyectos_I+D",
                        "programas_transformación",
                        "alianzas_tecnológicas",
                    ],
                    "capacidades_requeridas": [
                        "gestores_proyectos",
                        "facilitadores_innovación",
                ...
                },
                {
                    ...
                    "indicadores": [
                        "índice_innovación",
                        "productividad_tecnológica",
                        "eficiencia_institucional",
                    ],
                    "capacidades_requeridas": [
                        "evaluadores_tecnológicos",
                        "investigadores_innovación",
                        "analistas_políticas",
                    ],
                    "puntos_criticos": [
                        "medición_técnica",
                ...
                },
                {
                    ...
                    "tipo": "IMPACTOS",
                    "indicadores": [
                        "índice_economía_conocimiento",
                        "competitividad_global",
                        "transformación_productiva",
                    ],
                    "capacidades_requeridas": [
                        "investigadores_largo_plazo",
                        "economistas_innovación",
        ...
        },
        {
            ...
            "teoria_cambio": {
                "supuestos_causales": [
                    "Gestión fiscal eficiente → Sostenibilidad financiera",
                    "Transparencia presupuestal → Confianza inversionistas",
                ],
                "mediadores": {
                    "técnicos": [
                        "planeación_financiera",
                        "sistemas_control",
                        "gestión_riesgos",
                    ],
                    "institucionales": [
            ...
            "eslabones": [
                ...
                },
                {
                    ...
                    "indicadores": [
                        "planes_financieros",
                        "sistemas_control",
                        "mecanismos_transparencia",
                    ],
                    "capacidades_requeridas": [
                        "planificadores_financieros",
                        "auditores",
                        "analistas_presupuesto",
                    ],
                    "puntos_criticos": [
                        "eficiencia_procesos",
                        "control_calidad",
                ...
                },
                {
                    ...
                    "indicadores": [
                        ...
                        "sistemas_presupuestales",
                        "herramientas_análisis",
                    ],
                    "capacidades_requeridas": [
                        "analistas_financieros",
                        "desarrolladores_sistemas",
                        "especialistas_riesgo",
                    ],
                    "puntos_criticos": [
                        "calidad_técnica",
                        "sostenibilidad_operativa",
                        "actualización_normativa",
                    ],
                    "ventana_temporal": [18, 48],
                    "kpi_ponderacion": 1.2,
                },
                {
                    ...
                    "tipo": "RESULTADOS",
                    "indicadores": [
                        "índice_sostenibilidad_fiscal",
                        "eficiencia_gasto",
                        "percepción_riesgo",
                    ],
                    "capacidades_requeridas": [
                        "evaluadores_fiscales",
                        "investigadores_economía",
                        "analistas_políticas",
                    ],
                    "puntos_criticos": [
                        "medición_precisa",
                ...
                },
                {
                    ...
                    "tipo": "IMPACTOS",
                    "indicadores": [
                        "índice_estabilidad_económica",
                        "confianza_inversionista",
                        "desarrollo_sostenible",
                    ],
                    "capacidades_requeridas": [
                        "investigadores_largo_plazo",
                        "economistas_fiscales",
    ...
    try:
        ...
        LOGGER.warning(
            "⚠️  COMPLETE Y VALIDA MANUALMENTE EL ARCHIVO decalogo_industrial.json"
        )
    except Exception as e:
        LOGGER.error("❌ Error generando template industrial: {e}")
        raise SystemExit(
            "Fallo en generación de template - Requiere intervención manual"
        )
...
class ExtractorEvidenciaIndustrial:
    ...
    def _precomputar_embeddings(self):
        ...
        textos_validos = [
            texto for texto in self.textos_originales if len(texto.strip()) > 10
        ]
        if textos_validos:
            try:
                self.embeddings_doc = EMBEDDING_MODEL.encode(
                    textos_validos, convert_to_tensor=True
                )
                self.logger.info(
            ...
            self.embeddings_doc = torch.tensor([])
            self.logger.warning(
                f"⚠️  No hay textos suficientes para precomputar embeddings - {self.nombre_plan}"
            )
    ...
    def buscar_evidencia_causal(
        ...
        if (
            ...
            self.logger.warning(
                "⚠️  No hay embeddings precomputados disponibles, fallback a encoding en tiempo real"
            )
        ...
        try:
            ...
            indices_top = torch.topk(
                similitudes, min(top_k * 2, len(self.textos_originales))
            ).indices
            ...
            for idx in indices_top:
                ...
                relevancia_conceptual = coincidencias_conceptuales / max(
                    1, len(conceptos_clave)
                )
                ...
                densidad_causal = min(
                    1.0, densidad_causal / max(1, len(texto.split()) / 100)
                )
            ...
            self.logger.error(
                f"❌ Error en búsqueda causal con embeddings precomputados: {e}"
            )
    ...
    def _buscar_evidencia_fallback(
        ...
        try:
            ...
            doc_embeddings = EMBEDDING_MODEL.encode(
                self.textos_originales, convert_to_tensor=True
            )
    ...
    def buscar_segmentos_semanticos_global(
        ...
        if self.embeddings_doc.numel() == 0:
            self.logger.warning(
                "⚠️  No hay embeddings disponibles para búsqueda semántica global"
            )
            return []
        ...
        try:
            ...
            for batch_start in range(0, len(queries), batch_size):
                ...
                similitudes_batch = util.pytorch_cos_sim(
                    query_embeddings, self.embeddings_doc
                )
                    ...
                    for doc_idx, similitud in enumerate(similitudes):
                        ...
                        if doc_idx < len(self.textos_originales):
                            ...
                            if len(heap_global) < max_segmentos:
                                ...
                                heapq.heappush(
                                    heap_global,
                                    (score, doc_idx, query_idx_global, datos_segmento),
                                )
    ...
    def extraer_variables_operativas(
        self, dimension: DimensionDecalogo
    ) -> Dict[str, List]:
        ...
        try:
            ...
            self.logger.error(
                f"❌ Error extrayendo variables para dimensión {dimension.id}: {e}"
            )
        ...
        for field_name, value in self.__dict__.items():
            if isinstance(value, float) and not (0.0 <= value <= 1.0):
                if field_name not in ["evidencia_soporte", "brechas_criticas"]:
                    raise ValueError(
                        f"Campo {field_name} fuera de rango [0,1]: {value}"
                    )
    ...
    def generar_reporte_tecnico(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "diagnostico": {
                ...
                "riesgos_principales": self.evaluacion_causal.riesgos_implementacion[
                    :5
                ],
...
class PDFLoaderIndustrial:
    ...
    def __init__(self, file_path: Path):
        ...
        if not PDFPLUMBER_AVAILABLE:
            raise RuntimeError(
                "❌ pdfplumber no está instalado. Por favor, instale con: pip install pdfplumber"
            )
    ...
    def cargar(self) -> bool:
        ...
        try:
            ...
            self.logger.info(
                f"✅ Documento cargado: {len(self.paginas)} páginas - Hash: {self.hash_documento[:8]}"
            )
            return True
    ...
    def segmentar(self) -> bool:
        ...
        try:
            ...
            for i, pagina in enumerate(self.paginas, start=1):
                ...
                try:
                    ...
                    for sentencia in doc.sents:
                        ...
                        if len(texto) >= 20 and self._tiene_contenido_sustancial(
                            sentencia
                        ):
                            buffer.append(texto)
                            ...
                            if len(buffer) >= 3 or (
                                len(buffer) >= 2
                                and self._detectar_cambio_tematico(buffer)
                            ):
            ...
            self.logger.info(
                f"✅ Segmentación completada: {len(self.segmentos)} segmentos - {self.nombre_plan}"
            )
...
class SistemaEvaluacionIndustrial:
    ...
    def cargar_y_procesar(self) -> bool:
        ...
        self.logger.info(
            f"🔄 Iniciando procesamiento industrial de: {self.pdf_path.name}"
        )
...
def integrar_evaluador_decatalogo(
    ...
    try:
        ...
        from Decatalogo_evaluador import (
            integrar_evaluador_decatalogo as integrar_evaluador,
        )
        ...
        if resultado_decatalogo:
            ...
            if resultado_decatalogo.puntaje_final < 60:
                LOGGER.warning(
                    f"⚠️  [DECÁLOGO] Dimensión {dimension.id} tiene baja calidad: {resultado_decatalogo.puntaje_final:.1f}"
                )
...
class SistemaEvaluacionIndustrial:
    ...
    def inicializar(self) -> bool:
        ...
        try:
            ...
            self.hash_evaluacion = hashlib.sha256(
                f"{self.loader.hash_documento}_{datetime.now().isoformat()}".encode(
                    "utf-8"
                )
            ).hexdigest()

            self.logger.info(
                f"✅ Sistema preparado para evaluación industrial - Hash: {self.hash_evaluacion[:8]}"
            )
            return True
    ...
    def evaluar_dimension(
        ...
        try:
            ...
            evaluacion_causal = self._evaluar_coherencia_causal_industrial(
                dimension, evidencia
            )
            ...
            recomendaciones = self._generar_recomendaciones_industrial(
                dimension, evaluacion_causal, brechas
            )
            ...
            try:
                ...
                self.logger.warning(
                    f"⚠️  No se pudo importar el evaluador del decálogo: {e}"
                )
            except Exception as e:
            ...
            self.logger.error(
                f"❌ Error crítico evaluando dimensión {dimension.id}: {e}"
            )
    ...
    def _evaluar_coherencia_causal_industrial(
        ...
        try:
            ...
            identificabilidad = (
                1.0 if dimension.teoria_cambio.verificar_identificabilidad() else 0.3
            )
            ...
            if certeza < 0.7:
                riesgos.append(
                    "⚠️  Baja certeza causal: Requiere fortalecimiento de marco teórico"
                )
            if robustez < 0.6:
                riesgos.append(
                    "⚠️  Baja robustez causal: Requiere simplificación de relaciones causales"
                )

            # Conteo de brechas críticas
            brechas_criticas = len(
                self._identificar_brechas_industrial(dimension, evidencia)
            )
    ...
    def _calcular_factibilidad_industrial(
        ...
        if indicadores_encontrados >= indicadores_requeridos:
            ...
            factores.append(
                0.6 + (0.35 * indicadores_encontrados / indicadores_requeridos)
            )
        else:
            factores.append(0.1)

        # Factor 3: Presencia de responsables y plazos (peso 0.3)
        responsables_plazos = len(evidencia.get("responsables", [])) + len(
            evidencia.get("plazos", [])
        )
    ...
    def _identificar_brechas_industrial(
        ...
        if not evidencia.get("recursos", []):
            brechas.append(
                "🔴 BRECHA CRÍTICA: No se encontró especificación presupuestal o de recursos"
            )
        ...
        if not evidencia.get("plazos", []):
            brechas.append(
                "🟠 BRECHA IMPORTANTE: No se encontraron plazos o cronogramas definidos"
            )
    ...
    def _identificar_riesgos_industrial(
        ...
        if not evidencia.get("recursos", []):
            riesgos.append(
                "🔴 ALTO: Falta de especificación presupuestal - Riesgo de inviabilidad operativa"
            )
    ...
    def generar_reporte_tecnico_completo(
        ...
        try:
            ...
            analisis_agregado = {
                ...
                "desviacion_estandar": (
                    statistics.stdev(puntajes) if len(puntajes) > 1 else 0
                ),
                ...
                "nivel_madurez_predominante": (
                    max(set(niveles_madurez), key=niveles_madurez.count)
                    if niveles_madurez
                    else "N/A"
                ),
                "certidumbre_predominante": (
                    max(set(certidumbres), key=certidumbres.count)
                    if certidumbres
                    else "N/A"
                ),
                "recomendacion_estrategica_global": self._generar_recomendacion_global(
                    resultados
                ),
    ...
    def _generar_recomendacion_global(
        self, resultados: List[ResultadoDimensionIndustrial]
    ) -> str:
        ...
        if promedio >= 85:
            ...
            return (
                "IMPLEMENTACIÓN SELECTIVA RECOMENDADA - FORTALECER DIMENSIONES DÉBILES"
            )
        elif promedio >= 50:
    ...
    def _identificar_riesgos_sistemicos(
        self, resultados: List[ResultadoDimensionIndustrial]
    ) -> List[str]:
        ...
        riesgos_criticos = sum(
            len(r.evaluacion_causal.riesgos_implementacion) for r in resultados
        )
        ...
        return (
            riesgos_sistemicos
            if riesgos_sistemicos
            else ["✅ SIN RIESGOS SISTÉMICOS IDENTIFICADOS"]
        )
...
class GeneradorReporteIndustrial:
    ...
    def generar_reporte_markdown(
        ...
        reporte.append(
            "### 🎯 Análisis Multinivel con Enfoque Causal y Certificación de Rigor"
        )
        reporte.append(
            f"### 📊 Fecha de evaluación: {datetime.now().strftime('%Y-%m-%d %H:%M')}"
        )
        if metadata and metadata.get("hash_evaluacion"):
            reporte.append(
                f"### 🔐 Hash de evaluación: {metadata.get('hash_evaluacion', '')[:12]}..."
            )
        reporte.append("")
        ...
        if puntajes:
            ...
            reporte.append(
                f"**🏆 Dimensiones Excelentes (≥85):** {excelentes}/{len(resultados)}"
            )
            reporte.append(
                f"**⚠️  Dimensiones Deficientes (<70):** {deficientes}/{len(resultados)}"
            )

            # Nivel de madurez global
            niveles = [r.nivel_madurez for r in resultados]
            nivel_predominante = (
                max(set(niveles), key=niveles.count) if niveles else "N/A"
            )
            reporte.append(
                f"**🏭 Nivel de Madurez Predominante:** {nivel_predominante}"
            )
            ...
            reporte.append(
                f"**{emoji} Recomendación Estratégica Global:** {recomendacion_global}"
            )
            reporte.append("")
        ...
        for i, resultado in enumerate(resultados, 1):
            reporte.append(
                f"## 🔍 DIMENSIÓN {resultado.dimension.id}: {resultado.dimension.nombre}"
            )
            ...
            reporte.append(
                f"### 🎯 Certidumbre: {resultado.evaluacion_causal.nivel_certidumbre}"
            )
            reporte.append(
            ...
            reporte.append(
                f"- **Identificabilidad causal:** {ev.identificabilidad_causal:.3f}"
            )
            reporte.append(
                f"- **Factibilidad operativa:** {ev.factibilidad_operativa:.3f}"
            )
            reporte.append(
                f"- **Certeza probabilística:** {ev.certeza_probabilistica:.3f}"
            )
            reporte.append(f"- **Robustez causal:** {ev.robustez_causal:.3f}")
            reporte.append(
                f"- **Evidencia de soporte:** {ev.evidencia_soporte} elementos"
            )
            ...
            if evidencia_total > 0:
                ...
                for tipo, evidencias in resultado.evidencia.items():
                    if evidencias:
                        reporte.append(
                            f"**{tipo.upper()}:** ({len(evidencias)} elementos)"
                        )
                        for ev in evidencias[:2]:  # Top 2 evidencias por tipo
                            ...
                            reporte.append(
                                f"- Pág {ev['pagina']} (Score: {ev['score_final']:.3f}): {texto_resumido}"
                            )
                        reporte.append("")
        ...
        if puntajes:
            ...
            if promedio >= 85:
                ...
                reporte.append(
                    "   - El plan demuestra alto nivel de madurez y coherencia causal"
                )
                reporte.append(
                    "   - Se recomienda monitoreo continuo y ajustes menores"
                )
            elif promedio >= 70:
                reporte.append("⚠️  **APROBADO CON RECOMENDACIONES**")
                reporte.append(
                    "   - El plan es viable pero requiere mejoras en dimensiones específicas"
                )
                reporte.append(
                    "   - Priorizar implementación de recomendaciones en dimensiones deficientes"
                )
            elif promedio >= 50:
                reporte.append("🛠️  **REQUIERE REDISEÑO PARCIAL**")
                reporte.append(
                    "   - El plan tiene fundamentos válidos pero necesita mejoras sustanciales"
                )
                reporte.append(
                    "   - Priorizar rediseño de dimensiones con puntajes más bajos"
                )
            else:
                reporte.append("❌ **REQUIERE REDISEÑO INTEGRAL**")
                reporte.append(
                    "   - El plan presenta deficiencias estructurales significativas"
                )
                reporte.append(
                    "   - Se recomienda revisión estratégica fundamental antes de implementación"
                )

        reporte.append("")
        reporte.append("---")
        reporte.append(
            "*Reporte generado por Sistema Industrial de Evaluación de Políticas Públicas v8.0*"
        )
        reporte.append(
    ...
    def generar_reporte_json(
        resultados: List[ResultadoDimensionIndustrial],
        nombre_plan: str,
        sistema: SistemaEvaluacionIndustrial = None,
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "resumen_ejecutivo": {
                ...
                "dimensiones_evaluadas": len(resultados),
                "nivel_madurez_global": (
                    max([r.nivel_madurez for r in resultados]) if resultados else "N/A"
                ),
            },
...
def procesar_plan_industrial(
    pdf_path: Path, max_segmentos: Optional[int] = None, batch_size: int = 32
    ...
    try:
        ...
        if not sistema.cargar_y_procesar():
            ...
            return nombre_plan, {
                "error": "Falló carga y procesamiento",
                "status": "failed",
            }
        ...
        if max_segmentos and sistema.extractor:
            logger_worker.info(
                f"🔍 Aplicando selección global de top-{max_segmentos} segmentos con batch_size={batch_size}"
            )
            ...
            for dimension in DECALOGO_INDUSTRIAL:
                ...
                for eslabon in dimension.eslabones:
                    for indicador in eslabon.indicadores[
                        :2
                    ]:  # Top 2 indicadores por eslabón
                        queries_semanticas.append(f"{indicador} {dimension.nombre}")

                # Queries de teoría de cambio
                for supuesto in dimension.teoria_cambio.supuestos_causales[
                    :1
                ]:  # Top 1 supuesto
            ...
            segmentos_seleccionados = (
                sistema.extractor.buscar_segmentos_semanticos_global(
            ...
            if segmentos_seleccionados:
                ...
                sistema.extractor.textos_originales = [
                    doc[1] for doc in documentos_filtrados
                ]
                sistema.extractor._precomputar_embeddings()

                logger_worker.info(
                    f"✅ Segmentos filtrados: {len(documentos_filtrados)} de {len(sistema.loader.segmentos)} originales"
                )

        # Evaluar todas las dimensiones industriales
        resultados = []
        segmentos_totales = (
            len(sistema.loader.segmentos) if hasattr(sistema.loader, "segmentos") else 0
        )
        segmentos_procesados = (
            len(sistema.extractor.textos_originales) if sistema.extractor else 0
        )
        ...
        if not resultados:
            logger_worker.error(
                f"❌ No se pudo evaluar ninguna dimensión para: {nombre_plan}"
            )
            return nombre_plan, {
                "error": "No se pudo evaluar dimensiones",
                "status": "failed",
            }
...
class SistemaMonitoreoIndustrial:
    ...
    def registrar_ejecucion(self, nombre_plan: str, resultado: Dict[str, Any]):
        ...
        with self.lock:
            ...
            if resultado.get("status") == "completed":
                self.logger.info(
                    f"✅ Plan completado: {nombre_plan} - Puntaje: {resultado.get('puntaje_promedio', 0):.1f}"
                )
            else:
                self.logger.error(
                    f"❌ Plan fallido: {nombre_plan} - Error: {resultado.get('error', 'Desconocido')}"
                )
    ...
    def terminar_trabajadores(self):
        ...
        self.logger.warning(
            f"Terminando {len(trabajadores_activos_copia)} trabajadores activos..."
        )
    ...
    def generar_reporte_monitoreo(self) -> Dict[str, Any]:
        ...
        completados = [
            e for e in self.ejecuciones if e["resultado"].get("status") == "completed"
        ]
        fallidos = [
            e for e in self.ejecuciones if e["resultado"].get("status") == "failed"
        ]

        puntajes = [
            e["resultado"].get("puntaje_promedio", 0)
            for e in completados
            if e["resultado"].get("puntaje_promedio")
        ]
        ...
        reporte = {
            "metadata": {
                ...
                "tasa_exito": (
                    len(completados) / len(self.ejecuciones) if self.ejecuciones else 0
                ),
                "tiempo_total": (
                    str(datetime.now() - self.tiempo_inicio)
            ...
            "analisis_rendimiento": {
                ...
                "desviacion_estandar_global": (
                    statistics.stdev(puntajes) if len(puntajes) > 1 else 0
                ),
                "mejor_plan": (
                    max(
                        completados,
                        key=lambda x: x["resultado"].get("puntaje_promedio", 0),
                    )["nombre_plan"]
                    if completados
                    else "N/A"
                ),
                "peor_plan": (
                    min(
                        completados,
                        key=lambda x: x["resultado"].get("puntaje_promedio", 100),
                    )["nombre_plan"]
                    if completados
                    else "N/A"
                ),
            },
            "diagnostico_sistema": self._generar_diagnostico_sistema(
                completados, fallidos
            ),
            "recomendaciones_operativas": self._generar_recomendaciones_operativas(
                fallidos
            ),
        }
    ...
    def _generar_diagnostico_sistema(
        self, completados: List[Dict], fallidos: List[Dict]
    ) -> Dict[str, str]:
        """Genera diagnóstico del sistema de evaluación"""
        tasa_exito = (
            len(completados) / (len(completados) + len(fallidos))
            if (len(completados) + len(fallidos)) > 0
            else 0
        )
        ...
        if tasa_exito >= 0.95:
            ...
            estado = "BUENO"
            descripcion = (
                "Sistema operando con buen nivel de eficiencia, requiere monitoreo"
            )
        elif tasa_exito >= 0.70:
            estado = "ADECUADO"
            descripcion = (
                "Sistema operando a nivel aceptable, requiere mejoras puntuales"
            )
        else:
            estado = "CRÍTICO"
            descripcion = (
                "Sistema con problemas significativos, requiere intervención urgente"
            )
    ...
    def _generar_recomendaciones_operativas(self, fallidos: List[Dict]) -> List[str]:
        ...
        if len(fallidos) > 0:
            recomendaciones.append(
                "🔧 ANALIZAR PLANES FALLIDOS: Revisar logs de error para identificar patrones"
            )
            ...
            if any("PDF" in str(error) for error in errores):
                recomendaciones.append(
                    "📄 VERIFICAR FORMATO PDF: Algunos archivos pueden estar corruptos o protegidos"
                )

            if any(
                "memoria" in str(error).lower() or "memory" in str(error).lower()
                for error in errores
            ):
                recomendaciones.append(
                    "🧠 OPTIMIZAR MEMORIA: Reducir tamaño de batch o aumentar recursos del sistema"
                )
    ...
    def generar_dump_emergencia(self, output_dir: Path) -> Path:
        ...
        with self.lock:
            ...
            estado_emergencia = {
                ...
                "ejecuciones_completadas": len(
                    [
                        e
                        for e in self.ejecuciones
                        if e["resultado"].get("status") == "completed"
                    ]
                ),
                "ejecuciones_fallidas": len(
                    [
                        e
                        for e in self.ejecuciones
                        if e["resultado"].get("status") == "failed"
                    ]
                ),
    ...
    def _generar_recomendaciones_recuperacion(self) -> List[str]:
        ...
        if len(fallidos) > len(self.ejecuciones) * 0.2:
            recomendaciones.append(
                "Alta tasa de fallos detectada - revisar configuración del sistema"
            )
        ...
        if _sistema_monitoreo_global:
            try:
                ...
                if _sistema_monitoreo_global.ejecuciones:
                    reporte_final = (
                        _sistema_monitoreo_global.generar_reporte_monitoreo()
                    )
                    LOGGER.warning(
                        f"📈 Tasa de éxito parcial: {reporte_final.get('metadata', {}).get('tasa_exito', 0):.1%}"
                    )
...
def procesar_plan_industrial_con_monitoreo(
    pdf_path: Path,
) -> Tuple[str, Dict[str, Any]]:
...
Ejemplos de uso:
  ...
  python Decatalogo_principal.py ./planes/ --max-segmentos 500 --batch-size 64
    ...
    parser.add_argument(
        "input_path", help="Directorio con archivos PDF o archivo PDF individual"
    )
    ...
    if device_info["cuda_available"] and device_info["device_type"] == "cuda":
        LOGGER.info(
            f"🚀 CUDA disponible: {device_info['cuda_device_count']} dispositivos"
        )
    ...
    LOGGER.info(
        f"🚀 Iniciando sistema industrial de evaluación de políticas públicas v8.1"
    )
    ...
    if input_path.is_dir():
        ...
        if not pdf_paths:
            LOGGER.error(
                "❌ No se encontraron archivos PDF en el directorio especificado"
            )
            sys.exit(1)

        LOGGER.info(
            f"🏭 Procesando {len(pdf_paths)} planes de desarrollo en paralelo..."
        )
        ...
        puntajes_validos = [
            ...
            if "error" not in m and "puntaje_promedio" in m
        ]
        ...
        if puntajes_validos:
            meta_reporte = [
                ...
                (
                    f"## 📈 Desviación estándar: {statistics.stdev(puntajes_validos):.1f}"
            ...
            for i, (nombre, metricas) in enumerate(planes_ordenados, 1):
                meta_reporte.append(
                    f"{i}. {nombre}: {metricas.get('puntaje_promedio', 0):.1f}/100"
                )
            ...
            planes_deficientes = sorted(
                [
                    (n, m)
                    for n, m in zip(nombres, metrics_list)
                    if "error" not in m and m.get("puntaje_promedio", 100) < 70
                ],
                key=lambda x: x[1].get("puntaje_promedio", 0),
            )[:5]
            ...
            if planes_deficientes:
                ...
                meta_reporte.append(
                    "✅ Todos los planes superan el umbral mínimo de 70/100"
                )
            ...
            for i, recomendacion in enumerate(
                reporte_monitoreo["recomendaciones_operativas"], 1
            ):
            ...
            meta_reporte.append("---")
            meta_reporte.append(
                "*Generado por Sistema Industrial de Evaluación de Políticas Públicas v8.0*"
            )
        ...
        try:
            ...
            if "error" not in metrics:
                ...
                LOGGER.info(
                    f"📊 PUNTAJE FINAL: {metrics.get('puntaje_promedio', 0):.1f}/100"
                )
                LOGGER.info(
                    f"🏭 NIVEL DE MADUREZ: {metrics.get('nivel_madurez_predominante', 'N/A')}"
                )
                if args.max_segmentos:
                    LOGGER.info(
                        f"📊 SEGMENTOS PROCESADOS: {metrics.get('segmentos_procesados', 'N/A')}/{metrics.get('segmentos_totales', 'N/A')}"
                    )
            else:
                LOGGER.error(
                    f"❌❌❌ ERROR PROCESANDO {nombre_plan}: {metrics.get('error', 'Desconocido')}"
                )
                sys.exit(1)
        except KeyboardInterrupt:
            LOGGER.warning("🚨 Procesamiento interrumpido por el usuario")
...
if __name__ == "__main__":
    try:
        ...
        LOGGER.info(
            "🛑 Ejecución interrumpida - Limpieza completada por signal handler"
        )
        sys.exit(1)
    except Exception as e:
